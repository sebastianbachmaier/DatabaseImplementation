...
template<> struct LengthSwitch<1>
{
    typedef uint8_t type;
};
template<> struct LengthSwitch<2>
{
    typedef uint16_t type;
};
template<> struct LengthSwitch<4>
{
...
public:
    ...
    ///  Varchar concat
    template<unsigned maxLen2>
    Varchar<maxLen+maxLen2> operator+ ( const Varchar<maxLen2> b )
    {
        Varchar<maxLen+maxLen2> res;
        strcpy ( res.value, value );
        strcat ( res.value, b.value );
        return res;
    }

    template<unsigned newLen>
#if newLen < maxLen
#error impossible Varchar conversion
#else
    inline operator Varchar<newLen>() const
    {
    ...
    Varchar<maxLen>() = default;

    /// Type conversion
    Varchar<maxLen> ( const char* str )
    {
...
public:
    ...
    Numeric ( double x ) : value ( x*numericShifts[precision] ) {}
    Numeric ( int x ) : value ( x*numericShifts[precision] ) {}
    Numeric ( unsigned x ) : value ( x*numericShifts[precision] ) {}
    /// Assign a value
    ...
    /// Div
    template <unsigned l> Numeric<len,precision> operator/ ( const Numeric<l,0>& n ) const
    {
        Numeric r;
        r.value=value/n.value;
        return r;
    ...
    /// Div
    template <unsigned l> Numeric<len,precision> operator/ ( const Numeric<l,1>& n ) const
    {
        Numeric r;
    ...
    /// Div
    template <unsigned l> Numeric<len,precision> operator/ ( const Numeric<l,2>& n ) const
    {
        Numeric r;
    ...
    /// Div
    template <unsigned l> Numeric<len,precision> operator/ ( const Numeric<l,4>& n ) const
    {
        Numeric r;
    ...
    inline operator double() const
    {
        ...
        double res = ( ( double ) value ) /numericShifts[precision];
        return res;
    }
    /// Cast
